...
const MODULE_DEFS = [
  ...
  ["folder-automation", "Document folders (legacy Drive)", "Documents", "Legacy Google Drive folder provisioning — disabled; use Firebase Storage."],
  ...
  ["cv-routing", "CV routing (legacy Drive)", "Documents", "Legacy Drive CV routing — documents are stored in Firebase."],
  ...
  ["pdf-export", "PDF export", "Documents", "Export research and cover letters as PDF."],
...
const REQUIRED: Record<string, string[]> = {
  ...
  "job-intake": ["ai_provider"],
  "email-reply-detection": ["ai_provider"],
  "folder-automation": [],
  "cv-routing": ["active_cv"],
  "research-document": ["ai_provider"],
  "ai-processing": ["ai_provider"],
  "pdf-export": ["ai_provider"],

...
import type { ContactCommunicationEvent } from "@/types/contact";

interface ContactCommunicationTimelineProps {
  events: ContactCommunicationEvent[];
}

export function ContactCommunicationTimeline({ events }: ContactCommunicationTimelineProps) {
  return (

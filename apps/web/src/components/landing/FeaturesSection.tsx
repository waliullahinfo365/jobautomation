...
const FEATURES = [
  { icon: Mail, title: "Email Job Alerts", description: "Connect Gmail once via Unipile. Job alerts are imported into your pipeline so you can review and apply without copy-paste chaos.", colorAccent: "rgba(239,68,68,0.15)", iconColor: "#f87171", borderColor: "rgba(239,68,68,0.20)", glowColor: "rgba(239,68,68,0.10)" },
  ...
  { icon: Upload, title: "Secure Document Storage", description: "Upload your CV and cover letter templates once. Files are stored securely and ready to share from Apply Assistant on your phone.", colorAccent: "rgba(34,197,94,0.15)", iconColor: "#4ade80", borderColor: "rgba(34,197,94,0.20)", glowColor: "rgba(34,197,94,0.10)" },
  { icon: Calendar, title: "Interview Tracking", description: "Log interviews, keep prep notes, and optionally sync events to Google Calendar when you connect it.", colorAccent: "rgba(6,182,212,0.15)", iconColor: "#22d3ee", borderColor: "rgba(6,182,212,0.20)", glowColor: "rgba(6,182,212,0.10)" },
  { icon: Bell, title: "Follow-up Reminders", description: "Never forget a follow-up. Track due dates and get nudged when it’s time to follow up after you apply.", colorAccent: "rgba(245,158,11,0.15)", iconColor: "#fbbf24", borderColor: "rgba(245,158,11,0.20)", glowColor: "rgba(245,158,11,0.10)" },
  ...
  { icon: FileText, title: "Document Management", description: "Store and organize CVs, cover letters, and templates in-app. Share them from Apply Assistant when the employer form asks for files.", colorAccent: "rgba(249,115,22,0.15)", iconColor: "#fb923c", borderColor: "rgba(249,115,22,0.20)", glowColor: "rgba(249,115,22,0.10)" },

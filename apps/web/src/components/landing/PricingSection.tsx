...
const PLANS = [
  {
    ...
    badge: null,
    features: ["Up to 25 active job applications", "Gmail integration (1 account)", "Basic AI cover letters (5/month)", "Job pipeline & kanban board", "Manual follow-up reminders", "Basic analytics dashboard", "Email support"],
    missing: ["Unlimited AI cover letters", "Auto-follow-up automation", "Google Drive CV routing", "Interview prep AI", "Multi-language support", "Priority support"],
  ...
  },
  {
    ...
    badge: "Most Popular",
    features: ["Unlimited job applications", "Gmail integration (3 accounts)", "Unlimited AI cover letters", "Automated follow-up system", "Google Drive CV routing", "Interview scheduling + prep AI", "Multi-language support (15 languages)", "Advanced analytics & reports", "AI research assistant", "Priority email & chat support", "Weekly AI-powered digest", "Application export (PDF, CSV)"],
    missing: [],
  ...
  },
  {
    ...
    badge: null,
    features: ["Everything in Professional", "Unlimited Gmail accounts", "Custom AI model fine-tuning", "Dedicated account manager", "Custom integrations & webhooks", "SSO & team collaboration", "API access", "White-label reports", "SLA guarantee (99.9% uptime)", "Phone & Slack support", "Custom onboarding"],
    missing: [],
    cta: "Contact Sales",
    recommended: false,
  },

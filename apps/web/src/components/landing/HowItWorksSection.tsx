...
const STEPS = [
  {
    ...
    icon: Mail,
    title: "Connect Gmail",
    description: "Link Gmail via Unipile’s secure hosted login in under a minute. Job alerts flow into your Job Inbox — no Google password stored in NewJob Guru.",
    highlight: "Hosted connect · Scan now anytime",
  ...
  },
  {
    ...
    description: "AI extracts role, company, and requirements from job-alert emails, scores match quality, and imports real opportunities into your pipeline — skipping marketing noise.",
    highlight: "Powered by AI · Scores match to your profile",
  ...
  },
  {
    number: "04",
    icon: Zap,
    title: "Apply with Apply Assistant",
    description: "On your phone, open the job, share your CV and cover letter, use AI answers for form fields, then mark Applied. Track follow-ups and interviews in one pipeline.",
    highlight: "Mobile-first apply · You stay in control",

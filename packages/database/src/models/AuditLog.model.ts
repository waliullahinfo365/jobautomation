...
applyBaseIndexes(AuditLogSchema); AuditLogSchema.index({ tenantId: 1, userId: 1 }); AuditLogSchema.index({ tenantId: 1, entityType: 1 }); AuditLogSchema.index({ createdAt: -1 });

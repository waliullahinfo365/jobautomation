...
export const baseFields = { tenantId: { type: String, required: true }, createdBy: { type: String, required: true }, updatedBy: { type: String }, archivedAt: { type: Date, default: null }, deletedAt: { type: Date, default: null } } as const;

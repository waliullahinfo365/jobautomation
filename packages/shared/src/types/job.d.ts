...
export interface Job {
    ...
    description?: string;
    aiSummary?: string;
    duplicateStatus?: "Unique" | "Duplicate" | "Possible Duplicate" | "Skipped";
    duplicateOfJobId?: string;
    folderCreated?: boolean;
    driveFolderId?: string;
    driveFolderUrl?: string;
    folderProvisionStatus?: "Not Started" | "Queued" | "Completed" | "Failed";
    folderProvisionedAt?: string;
    folderProvisionError?: string;
    tags?: string[];
    notes?: string;
    rawSourceData?: Record<string, unknown>;
    aiProcessingStatus?: "Not Started" | "Queued" | "Processing" | "Completed" | "Failed";
